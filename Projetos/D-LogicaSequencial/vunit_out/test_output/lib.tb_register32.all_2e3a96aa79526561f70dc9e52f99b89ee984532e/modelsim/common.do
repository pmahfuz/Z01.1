...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini /home/borg/Desktop/ELEMENTOS/gitDoGrupo/Z01.1-Alphabet/Projetos/D-LogicaSequencial/vunit_out/modelsim/modelsim.ini -wlf {/home/borg/Desktop/ELEMENTOS/gitDoGrupo/Z01.1-Alphabet/Projetos/D-LogicaSequencial/vunit_out/test_output/lib.tb_register32.all_2e3a96aa79526561f70dc9e52f99b89ee984532e/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_register32/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : /home/borg/Desktop/ELEMENTOS/gitDoGrupo/Z01.1-Alphabet/Projetos/D-LogicaSequencial/vunit_out/test_output/lib.tb_register32.all_2e3a96aa79526561f70dc9e52f99b89ee984532e/,tb path : /home/borg/Desktop/ELEMENTOS/gitDoGrupo/Z01.1-Alphabet/Projetos/D-LogicaSequencial/testes/,use_color : true"} lib.tb_register32(tb)   -L vunit_lib -L lib}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini /home/borg/Desktop/ELEMENTOS/gitDoGrupo/Z01.1-Alphabet/Projetos/D-LogicaSequencial/vunit_out/modelsim/modelsim.ini -wlf {/home/borg/Desktop/ELEMENTOS/gitDoGrupo/Z01.1-Alphabet/Projetos/D-LogicaSequencial/vunit_out/test_output/lib.tb_register32.all_2e3a96aa79526561f70dc9e52f99b89ee984532e/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_register32/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : /home/borg/Desktop/ELEMENTOS/gitDoGrupo/Z01.1-Alphabet/Projetos/D-LogicaSequencial/vunit_out/test_output/lib.tb_register32.all_2e3a96aa79526561f70dc9e52f99b89ee984532e/,tb path : /home/borg/Desktop/ELEMENTOS/gitDoGrupo/Z01.1-Alphabet/Projetos/D-LogicaSequencial/testes/,use_color : true"} lib.tb_register32(tb)   -L vunit_lib -L lib' failed
...
proc is_test_suite_done {} {
    set fd [open "/home/borg/Desktop/ELEMENTOS/gitDoGrupo/Z01.1-Alphabet/Projetos/D-LogicaSequencial/vunit_out/test_output/lib.tb_register32.all_2e3a96aa79526561f70dc9e52f99b89ee984532e/vunit_results" "r"]
...
proc vunit_compile {} {
    ...
    set chan [open |[list {/usr/bin/python3} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['/usr/bin/python3', '-u', './testeLogicaSequencial.py', '--compile'], cwd='/home/borg/Desktop/ELEMENTOS/gitDoGrupo/Z01.1-Alphabet/Projetos/D-LogicaSequencial', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
